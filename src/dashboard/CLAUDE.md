...
| `/api/preview-inbox` | GET | `PreviewInboxRow[]` — cross-workflow preview rows (`data.mode === "prepare"`, status `done`, step ≠ `approved`/`discarded`) sorted newest first | Backend only (TopBar `ApprovalInbox` removed 2026-05-06) |
