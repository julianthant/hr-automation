// Legacy onboarding workflow — used by parallel.ts. Will be removed when parallel mode migrates to the kernel. See docs/superpowers/plans/2026-04-15-migrate-onboarding-single-mode-plan.md.
...
export async function runOnboardingLegacy(
  email: string,
