...
- Auth chain — one global strategy, no per-workflow knob. 1 system → fast path; ≥2 → parallel-staggered with 2s settle + 5s stagger + 2-Duo concurrency cap. See `src/infra/auth/CLAUDE.md`.
