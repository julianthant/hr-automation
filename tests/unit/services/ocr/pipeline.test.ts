...
import { runOcrPipeline } from "../../../../src/services/ocr/pipeline.js";
      ...
      _poolOverride: [
        {
          ...
          rotationKey: "k1",
          priority: 1,
          models: [{ id: "test-model", limit: { rpm: 1000, tpm: 1_000_000, rpd: 1000, imgTokens: 1 }, tier: 2, trust: "unbenchmarked" }],
          callOcr: async () => ({ json: [] }),
        },
      ],
    });
