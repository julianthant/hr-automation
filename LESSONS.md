...
- **2026-05-17: data.archetype now fully canonical; legacy fallbacks read-only.** All write sites stamp archetype; queue/log/dashboard dispatch reads only resolveRowArchetype. See root CLAUDE.md "Row & Workflow Archetypes" section + src/domain/row-archetype.ts.
